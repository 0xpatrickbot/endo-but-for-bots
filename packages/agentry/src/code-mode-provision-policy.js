...
const normalizePolicy = async (spec, cwd, pinnedGitRoots = undefined) => {
  ...
  if (
    ...
    throw makeError(
      X`writable Git requires a writable filesystem grant; fs: 'readOnly' cannot be combined with a writable Git grant on the compatibility workspace`,
    );
  }
