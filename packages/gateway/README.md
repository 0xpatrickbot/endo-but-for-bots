...
(Feature 8), phase 3's admin daemon (Feature 7), phase 2's UDS
bootstrap registrar (Feature 4), and the phase-1 skeleton's
package shape. Phase 7 promotes Feature 2's `AppsNameHub` from
