...
export const HostInterface = M.interface('EndoHost', {
  ...
  // The method can optionally fork retained powers from a parent session.
  // The record and fork options are deeply validated with the shared shapes
  // inside the method (`src/provision.js`).
  // The guard stays structural because importing the deep shapes here would
  // close an import cycle through `mount.js`.
