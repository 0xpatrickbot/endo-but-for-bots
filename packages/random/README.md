...
A `fast-check` / `pure-rand` `RandomGenerator` adapter for these sources is published separately as a sibling package; see [`@endo/random-fast-check`](../random-fast-check/README.md).
